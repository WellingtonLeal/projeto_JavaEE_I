            ...
            <form role="form" method="POST" action="${pageContext.request.contextPath}/admin/pacientes?action=list">
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="telefone" name="telefone" class="form-control" value="${paciente.telefone}" id="telefone" placeholder="Informe o telefone">
                </div>
              ...
              <div class="box-footer">
					...
					<a href="${pageContext.request.contextPath}/admin/paciente?action=list" class="btn btn-sm btn-default">Pacientes</a>&nbsp;&nbsp;&nbsp;&nbsp;
              </div>
            </form>
      	</div>
